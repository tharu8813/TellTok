namespace telltok.play {
	partial class AddFriend {
		...
		private void InitializeComponent() {
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(369, 103);
			...
			this.label1.Text = "친구 추가 ID만 있으면 언제든지 추가할 수 있어요! 친구 추가 ID의 8자리 번호를 입력해 보세요. 나의 친구 추가 번호는 {} 에요!";
			// 
			// maskedTextBox1
			// 
			this.maskedTextBox1.Font = new System.Drawing.Font("굴림", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
			this.maskedTextBox1.Location = new System.Drawing.Point(16, 80);
			this.maskedTextBox1.Mask = "00000000";
			this.maskedTextBox1.Name = "maskedTextBox1";
			this.maskedTextBox1.Size = new System.Drawing.Size(369, 26);
			...
			this.button1.Text = "내 친구추가 ID 복사하기";
			...
			this.Name = "AddFriend";
			this.Text = "TellTok - 친구추가";
			this.Load += new System.EventHandler(this.AddFriend_Load);
			this.Shown += new System.EventHandler(this.AddFriend_Shown);
